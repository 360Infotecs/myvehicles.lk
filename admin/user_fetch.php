...
{
	$query .='select su.Id,su.UserId,su.UserName,su.PhoneNo,su.UserLevel as UserLevelId,ul.Name as UserLevel,
	su.Status as UserStatusId,us.Name as UserStatus,su.StatusUpdatedBy,su.StatusUpdatedDate,su.CreatedBy,
	su.CreatedDate from systemuser su left join userlevel ul on ul.Id = su.UserLevel 
	left join userstatus us on us.Id = su.Status where su.UserId!="'.$currentuserid.'" ';
}
else if($currentuser==='2')//System Admin
{
	...
	su.Status as UserStatusId,us.Name as UserStatus,su.StatusUpdatedBy,su.StatusUpdatedDate,su.CreatedBy,
	su.CreatedDate from systemuser su left join userlevel ul on ul.Id = su.UserLevel 
	left join userstatus us on us.Id = su.Status where su.Status != 3 and su.UserLevel!=1 and su.UserLevel!=2 ';
}
else if($currentuser==='3')//Level 1 User
{
	...
	su.Status as UserStatusId,us.Name as UserStatus,su.StatusUpdatedBy,su.StatusUpdatedDate,su.CreatedBy,
	su.CreatedDate from systemuser su left join userlevel ul on ul.Id = su.UserLevel 
	left join userstatus us on us.Id = su.Status where su.Status != 3 
	and su.UserLevel!=1 and su.UserLevel!=2 and su.UserLevel!=3 and su.CreatedBy="'.$currentuserid.'" ';
}
else if($currentuser==='4')//Level 2 User
{
	...
	su.CreatedDate from systemuser su left join userlevel ul on ul.Id = su.UserLevel 
	left join userstatus us on us.Id = su.Status where su.Status != 3 
	and su.UserLevel=5 and su.CreatedBy="'.$currentuserid.'" ';
...
$output = array(
	...
	"recordsFiltered"	=>	get_total_user_records(),
	"data"				=>	$data
);
