...
<title>MyVehicles.lk - Dealers List</title>
<?php
		  ...
		  <div class="dealers_listing">
			<div class="row">
			  <div class="col-sm-3 col-xs-4">
				<div class="dealer_logo"> <a href="dealers-profile.php"><img src="assets/images/dealer-logo.jpg" alt="image"></a> </div>
			  </div>
			  <div class="col-sm-6 col-xs-8">
				<div class="dealer_info">
				  <h5><a href="dealers-profile.php">Autospot Used Cars Center </a></h5>
				  <p>P.1225 N Broadway Ave<br>
					Oklahoma City, OK  1234-5678-090</p>
				</div>
			  </div>
			  <div class="col-sm-3 col-xs-12">
				<div class="view_profile"> <a href="dealers-profile.php" class="btn btn-xs outline">View Profile</a>
				  <p>(25 Cars)</p>
				</div>
			  </div>
			</div>
